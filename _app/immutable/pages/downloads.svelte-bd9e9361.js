import{S as Et,i as Tt,s as St,x as kt,a as fe,l as G,u as O,y as Rt,c as me,m as D,p as U,v as P,h as x,q as _,z as Ct,b as X,G as R,f as It,t as $t,C as xt,F as Nt,n as Le}from"../chunks/index-83fb3bf0.js";import{T as Lt}from"../chunks/Title-c986be92.js";var z={exports:{}};const Ot="2.0.0",Pt=256,Bt=Number.MAX_SAFE_INTEGER||9007199254740991,Ft=16;var ge={SEMVER_SPEC_VERSION:Ot,MAX_LENGTH:Pt,MAX_SAFE_INTEGER:Bt,MAX_SAFE_COMPONENT_LENGTH:Ft};const Gt=typeof process=="object"&&process.env&&process.env.NODE_DEBUG&&/\bsemver\b/i.test(process.env.NODE_DEBUG)?(...r)=>console.error("SEMVER",...r):()=>{};var we=Gt;(function(r,e){const{MAX_SAFE_COMPONENT_LENGTH:t}=ge,n=we;e=r.exports={};const s=e.re=[],a=e.src=[],i=e.t={};let c=0;const o=(w,l,d)=>{const v=c++;n(w,v,l),i[w]=v,a[v]=l,s[v]=new RegExp(l,d?"g":void 0)};o("NUMERICIDENTIFIER","0|[1-9]\\d*"),o("NUMERICIDENTIFIERLOOSE","[0-9]+"),o("NONNUMERICIDENTIFIER","\\d*[a-zA-Z-][a-zA-Z0-9-]*"),o("MAINVERSION",`(${a[i.NUMERICIDENTIFIER]})\\.(${a[i.NUMERICIDENTIFIER]})\\.(${a[i.NUMERICIDENTIFIER]})`),o("MAINVERSIONLOOSE",`(${a[i.NUMERICIDENTIFIERLOOSE]})\\.(${a[i.NUMERICIDENTIFIERLOOSE]})\\.(${a[i.NUMERICIDENTIFIERLOOSE]})`),o("PRERELEASEIDENTIFIER",`(?:${a[i.NUMERICIDENTIFIER]}|${a[i.NONNUMERICIDENTIFIER]})`),o("PRERELEASEIDENTIFIERLOOSE",`(?:${a[i.NUMERICIDENTIFIERLOOSE]}|${a[i.NONNUMERICIDENTIFIER]})`),o("PRERELEASE",`(?:-(${a[i.PRERELEASEIDENTIFIER]}(?:\\.${a[i.PRERELEASEIDENTIFIER]})*))`),o("PRERELEASELOOSE",`(?:-?(${a[i.PRERELEASEIDENTIFIERLOOSE]}(?:\\.${a[i.PRERELEASEIDENTIFIERLOOSE]})*))`),o("BUILDIDENTIFIER","[0-9A-Za-z-]+"),o("BUILD",`(?:\\+(${a[i.BUILDIDENTIFIER]}(?:\\.${a[i.BUILDIDENTIFIER]})*))`),o("FULLPLAIN",`v?${a[i.MAINVERSION]}${a[i.PRERELEASE]}?${a[i.BUILD]}?`),o("FULL",`^${a[i.FULLPLAIN]}$`),o("LOOSEPLAIN",`[v=\\s]*${a[i.MAINVERSIONLOOSE]}${a[i.PRERELEASELOOSE]}?${a[i.BUILD]}?`),o("LOOSE",`^${a[i.LOOSEPLAIN]}$`),o("GTLT","((?:<|>)?=?)"),o("XRANGEIDENTIFIERLOOSE",`${a[i.NUMERICIDENTIFIERLOOSE]}|x|X|\\*`),o("XRANGEIDENTIFIER",`${a[i.NUMERICIDENTIFIER]}|x|X|\\*`),o("XRANGEPLAIN",`[v=\\s]*(${a[i.XRANGEIDENTIFIER]})(?:\\.(${a[i.XRANGEIDENTIFIER]})(?:\\.(${a[i.XRANGEIDENTIFIER]})(?:${a[i.PRERELEASE]})?${a[i.BUILD]}?)?)?`),o("XRANGEPLAINLOOSE",`[v=\\s]*(${a[i.XRANGEIDENTIFIERLOOSE]})(?:\\.(${a[i.XRANGEIDENTIFIERLOOSE]})(?:\\.(${a[i.XRANGEIDENTIFIERLOOSE]})(?:${a[i.PRERELEASELOOSE]})?${a[i.BUILD]}?)?)?`),o("XRANGE",`^${a[i.GTLT]}\\s*${a[i.XRANGEPLAIN]}$`),o("XRANGELOOSE",`^${a[i.GTLT]}\\s*${a[i.XRANGEPLAINLOOSE]}$`),o("COERCE",`(^|[^\\d])(\\d{1,${t}})(?:\\.(\\d{1,${t}}))?(?:\\.(\\d{1,${t}}))?(?:$|[^\\d])`),o("COERCERTL",a[i.COERCE],!0),o("LONETILDE","(?:~>?)"),o("TILDETRIM",`(\\s*)${a[i.LONETILDE]}\\s+`,!0),e.tildeTrimReplace="$1~",o("TILDE",`^${a[i.LONETILDE]}${a[i.XRANGEPLAIN]}$`),o("TILDELOOSE",`^${a[i.LONETILDE]}${a[i.XRANGEPLAINLOOSE]}$`),o("LONECARET","(?:\\^)"),o("CARETTRIM",`(\\s*)${a[i.LONECARET]}\\s+`,!0),e.caretTrimReplace="$1^",o("CARET",`^${a[i.LONECARET]}${a[i.XRANGEPLAIN]}$`),o("CARETLOOSE",`^${a[i.LONECARET]}${a[i.XRANGEPLAINLOOSE]}$`),o("COMPARATORLOOSE",`^${a[i.GTLT]}\\s*(${a[i.LOOSEPLAIN]})$|^$`),o("COMPARATOR",`^${a[i.GTLT]}\\s*(${a[i.FULLPLAIN]})$|^$`),o("COMPARATORTRIM",`(\\s*)${a[i.GTLT]}\\s*(${a[i.LOOSEPLAIN]}|${a[i.XRANGEPLAIN]})`,!0),e.comparatorTrimReplace="$1$2$3",o("HYPHENRANGE",`^\\s*(${a[i.XRANGEPLAIN]})\\s+-\\s+(${a[i.XRANGEPLAIN]})\\s*$`),o("HYPHENRANGELOOSE",`^\\s*(${a[i.XRANGEPLAINLOOSE]})\\s+-\\s+(${a[i.XRANGEPLAINLOOSE]})\\s*$`),o("STAR","(<|>)?=?\\s*\\*"),o("GTE0","^\\s*>=\\s*0\\.0\\.0\\s*$"),o("GTE0PRE","^\\s*>=\\s*0\\.0\\.0-0\\s*$")})(z,z.exports);const Dt=["includePrerelease","loose","rtl"],Ut=r=>r?typeof r!="object"?{loose:!0}:Dt.filter(e=>r[e]).reduce((e,t)=>(e[t]=!0,e),{}):{};var ve=Ut;const _e=/^[0-9]+$/,ct=(r,e)=>{const t=_e.test(r),n=_e.test(e);return t&&n&&(r=+r,e=+e),r===e?0:t&&!n?-1:n&&!t?1:r<e?-1:1},_t=(r,e)=>ct(e,r);var Ne={compareIdentifiers:ct,rcompareIdentifiers:_t};const de=we,{MAX_LENGTH:He,MAX_SAFE_INTEGER:he}=ge,{re:Ve,t:je}=z.exports,Ht=ve,{compareIdentifiers:Q}=Ne;class H{constructor(e,t){if(t=Ht(t),e instanceof H){if(e.loose===!!t.loose&&e.includePrerelease===!!t.includePrerelease)return e;e=e.version}else if(typeof e!="string")throw new TypeError(`Invalid Version: ${e}`);if(e.length>He)throw new TypeError(`version is longer than ${He} characters`);de("SemVer",e,t),this.options=t,this.loose=!!t.loose,this.includePrerelease=!!t.includePrerelease;const n=e.trim().match(t.loose?Ve[je.LOOSE]:Ve[je.FULL]);if(!n)throw new TypeError(`Invalid Version: ${e}`);if(this.raw=e,this.major=+n[1],this.minor=+n[2],this.patch=+n[3],this.major>he||this.major<0)throw new TypeError("Invalid major version");if(this.minor>he||this.minor<0)throw new TypeError("Invalid minor version");if(this.patch>he||this.patch<0)throw new TypeError("Invalid patch version");n[4]?this.prerelease=n[4].split(".").map(s=>{if(/^[0-9]+$/.test(s)){const a=+s;if(a>=0&&a<he)return a}return s}):this.prerelease=[],this.build=n[5]?n[5].split("."):[],this.format()}format(){return this.version=`${this.major}.${this.minor}.${this.patch}`,this.prerelease.length&&(this.version+=`-${this.prerelease.join(".")}`),this.version}toString(){return this.version}compare(e){if(de("SemVer.compare",this.version,this.options,e),!(e instanceof H)){if(typeof e=="string"&&e===this.version)return 0;e=new H(e,this.options)}return e.version===this.version?0:this.compareMain(e)||this.comparePre(e)}compareMain(e){return e instanceof H||(e=new H(e,this.options)),Q(this.major,e.major)||Q(this.minor,e.minor)||Q(this.patch,e.patch)}comparePre(e){if(e instanceof H||(e=new H(e,this.options)),this.prerelease.length&&!e.prerelease.length)return-1;if(!this.prerelease.length&&e.prerelease.length)return 1;if(!this.prerelease.length&&!e.prerelease.length)return 0;let t=0;do{const n=this.prerelease[t],s=e.prerelease[t];if(de("prerelease compare",t,n,s),n===void 0&&s===void 0)return 0;if(s===void 0)return 1;if(n===void 0)return-1;if(n===s)continue;return Q(n,s)}while(++t)}compareBuild(e){e instanceof H||(e=new H(e,this.options));let t=0;do{const n=this.build[t],s=e.build[t];if(de("prerelease compare",t,n,s),n===void 0&&s===void 0)return 0;if(s===void 0)return 1;if(n===void 0)return-1;if(n===s)continue;return Q(n,s)}while(++t)}inc(e,t){switch(e){case"premajor":this.prerelease.length=0,this.patch=0,this.minor=0,this.major++,this.inc("pre",t);break;case"preminor":this.prerelease.length=0,this.patch=0,this.minor++,this.inc("pre",t);break;case"prepatch":this.prerelease.length=0,this.inc("patch",t),this.inc("pre",t);break;case"prerelease":this.prerelease.length===0&&this.inc("patch",t),this.inc("pre",t);break;case"major":(this.minor!==0||this.patch!==0||this.prerelease.length===0)&&this.major++,this.minor=0,this.patch=0,this.prerelease=[];break;case"minor":(this.patch!==0||this.prerelease.length===0)&&this.minor++,this.patch=0,this.prerelease=[];break;case"patch":this.prerelease.length===0&&this.patch++,this.prerelease=[];break;case"pre":if(this.prerelease.length===0)this.prerelease=[0];else{let n=this.prerelease.length;for(;--n>=0;)typeof this.prerelease[n]=="number"&&(this.prerelease[n]++,n=-2);n===-1&&this.prerelease.push(0)}t&&(Q(this.prerelease[0],t)===0?isNaN(this.prerelease[1])&&(this.prerelease=[t,0]):this.prerelease=[t,0]);break;default:throw new Error(`invalid increment argument: ${e}`)}return this.format(),this.raw=this.version,this}}var B=H;const{MAX_LENGTH:Vt}=ge,{re:Me,t:We}=z.exports,qe=B,jt=ve,Mt=(r,e)=>{if(e=jt(e),r instanceof qe)return r;if(typeof r!="string"||r.length>Vt||!(e.loose?Me[We.LOOSE]:Me[We.FULL]).test(r))return null;try{return new qe(r,e)}catch{return null}};var re=Mt;const Wt=re,qt=(r,e)=>{const t=Wt(r,e);return t?t.version:null};var Xt=qt;const zt=re,Yt=(r,e)=>{const t=zt(r.trim().replace(/^[=v]+/,""),e);return t?t.version:null};var Jt=Yt;const Xe=B,Zt=(r,e,t,n)=>{typeof t=="string"&&(n=t,t=void 0);try{return new Xe(r instanceof Xe?r.version:r,t).inc(e,n).version}catch{return null}};var Kt=Zt;const ze=B,Qt=(r,e,t)=>new ze(r,t).compare(new ze(e,t));var j=Qt;const er=j,tr=(r,e,t)=>er(r,e,t)===0;var Oe=tr;const Ye=re,rr=Oe,nr=(r,e)=>{if(rr(r,e))return null;{const t=Ye(r),n=Ye(e),s=t.prerelease.length||n.prerelease.length,a=s?"pre":"",i=s?"prerelease":"";for(const c in t)if((c==="major"||c==="minor"||c==="patch")&&t[c]!==n[c])return a+c;return i}};var ar=nr;const sr=B,ir=(r,e)=>new sr(r,e).major;var or=ir;const lr=B,dr=(r,e)=>new lr(r,e).minor;var hr=dr;const cr=B,ur=(r,e)=>new cr(r,e).patch;var br=ur;const fr=re,mr=(r,e)=>{const t=fr(r,e);return t&&t.prerelease.length?t.prerelease:null};var pr=mr;const gr=j,wr=(r,e,t)=>gr(e,r,t);var vr=wr;const Ar=j,yr=(r,e)=>Ar(r,e,!0);var Er=yr;const Je=B,Tr=(r,e,t)=>{const n=new Je(r,t),s=new Je(e,t);return n.compare(s)||n.compareBuild(s)};var Pe=Tr;const Sr=Pe,kr=(r,e)=>r.sort((t,n)=>Sr(t,n,e));var Rr=kr;const Cr=Pe,Ir=(r,e)=>r.sort((t,n)=>Cr(n,t,e));var $r=Ir;const xr=j,Nr=(r,e,t)=>xr(r,e,t)>0;var Ae=Nr;const Lr=j,Or=(r,e,t)=>Lr(r,e,t)<0;var Be=Or;const Pr=j,Br=(r,e,t)=>Pr(r,e,t)!==0;var ut=Br;const Fr=j,Gr=(r,e,t)=>Fr(r,e,t)>=0;var Fe=Gr;const Dr=j,Ur=(r,e,t)=>Dr(r,e,t)<=0;var Ge=Ur;const _r=Oe,Hr=ut,Vr=Ae,jr=Fe,Mr=Be,Wr=Ge,qr=(r,e,t,n)=>{switch(e){case"===":return typeof r=="object"&&(r=r.version),typeof t=="object"&&(t=t.version),r===t;case"!==":return typeof r=="object"&&(r=r.version),typeof t=="object"&&(t=t.version),r!==t;case"":case"=":case"==":return _r(r,t,n);case"!=":return Hr(r,t,n);case">":return Vr(r,t,n);case">=":return jr(r,t,n);case"<":return Mr(r,t,n);case"<=":return Wr(r,t,n);default:throw new TypeError(`Invalid operator: ${e}`)}};var bt=qr;const Xr=B,zr=re,{re:ce,t:ue}=z.exports,Yr=(r,e)=>{if(r instanceof Xr)return r;if(typeof r=="number"&&(r=String(r)),typeof r!="string")return null;e=e||{};let t=null;if(!e.rtl)t=r.match(ce[ue.COERCE]);else{let n;for(;(n=ce[ue.COERCERTL].exec(r))&&(!t||t.index+t[0].length!==r.length);)(!t||n.index+n[0].length!==t.index+t[0].length)&&(t=n),ce[ue.COERCERTL].lastIndex=n.index+n[1].length+n[2].length;ce[ue.COERCERTL].lastIndex=-1}return t===null?null:zr(`${t[2]}.${t[3]||"0"}.${t[4]||"0"}`,e)};var Jr=Yr,Te,Ze;function Zr(){return Ze||(Ze=1,Te=function(r){r.prototype[Symbol.iterator]=function*(){for(let e=this.head;e;e=e.next)yield e.value}}),Te}var Kr=S;S.Node=K;S.create=S;function S(r){var e=this;if(e instanceof S||(e=new S),e.tail=null,e.head=null,e.length=0,r&&typeof r.forEach=="function")r.forEach(function(s){e.push(s)});else if(arguments.length>0)for(var t=0,n=arguments.length;t<n;t++)e.push(arguments[t]);return e}S.prototype.removeNode=function(r){if(r.list!==this)throw new Error("removing node which does not belong to this list");var e=r.next,t=r.prev;return e&&(e.prev=t),t&&(t.next=e),r===this.head&&(this.head=e),r===this.tail&&(this.tail=t),r.list.length--,r.next=null,r.prev=null,r.list=null,e};S.prototype.unshiftNode=function(r){if(r!==this.head){r.list&&r.list.removeNode(r);var e=this.head;r.list=this,r.next=e,e&&(e.prev=r),this.head=r,this.tail||(this.tail=r),this.length++}};S.prototype.pushNode=function(r){if(r!==this.tail){r.list&&r.list.removeNode(r);var e=this.tail;r.list=this,r.prev=e,e&&(e.next=r),this.tail=r,this.head||(this.head=r),this.length++}};S.prototype.push=function(){for(var r=0,e=arguments.length;r<e;r++)en(this,arguments[r]);return this.length};S.prototype.unshift=function(){for(var r=0,e=arguments.length;r<e;r++)tn(this,arguments[r]);return this.length};S.prototype.pop=function(){if(!!this.tail){var r=this.tail.value;return this.tail=this.tail.prev,this.tail?this.tail.next=null:this.head=null,this.length--,r}};S.prototype.shift=function(){if(!!this.head){var r=this.head.value;return this.head=this.head.next,this.head?this.head.prev=null:this.tail=null,this.length--,r}};S.prototype.forEach=function(r,e){e=e||this;for(var t=this.head,n=0;t!==null;n++)r.call(e,t.value,n,this),t=t.next};S.prototype.forEachReverse=function(r,e){e=e||this;for(var t=this.tail,n=this.length-1;t!==null;n--)r.call(e,t.value,n,this),t=t.prev};S.prototype.get=function(r){for(var e=0,t=this.head;t!==null&&e<r;e++)t=t.next;if(e===r&&t!==null)return t.value};S.prototype.getReverse=function(r){for(var e=0,t=this.tail;t!==null&&e<r;e++)t=t.prev;if(e===r&&t!==null)return t.value};S.prototype.map=function(r,e){e=e||this;for(var t=new S,n=this.head;n!==null;)t.push(r.call(e,n.value,this)),n=n.next;return t};S.prototype.mapReverse=function(r,e){e=e||this;for(var t=new S,n=this.tail;n!==null;)t.push(r.call(e,n.value,this)),n=n.prev;return t};S.prototype.reduce=function(r,e){var t,n=this.head;if(arguments.length>1)t=e;else if(this.head)n=this.head.next,t=this.head.value;else throw new TypeError("Reduce of empty list with no initial value");for(var s=0;n!==null;s++)t=r(t,n.value,s),n=n.next;return t};S.prototype.reduceReverse=function(r,e){var t,n=this.tail;if(arguments.length>1)t=e;else if(this.tail)n=this.tail.prev,t=this.tail.value;else throw new TypeError("Reduce of empty list with no initial value");for(var s=this.length-1;n!==null;s--)t=r(t,n.value,s),n=n.prev;return t};S.prototype.toArray=function(){for(var r=new Array(this.length),e=0,t=this.head;t!==null;e++)r[e]=t.value,t=t.next;return r};S.prototype.toArrayReverse=function(){for(var r=new Array(this.length),e=0,t=this.tail;t!==null;e++)r[e]=t.value,t=t.prev;return r};S.prototype.slice=function(r,e){e=e||this.length,e<0&&(e+=this.length),r=r||0,r<0&&(r+=this.length);var t=new S;if(e<r||e<0)return t;r<0&&(r=0),e>this.length&&(e=this.length);for(var n=0,s=this.head;s!==null&&n<r;n++)s=s.next;for(;s!==null&&n<e;n++,s=s.next)t.push(s.value);return t};S.prototype.sliceReverse=function(r,e){e=e||this.length,e<0&&(e+=this.length),r=r||0,r<0&&(r+=this.length);var t=new S;if(e<r||e<0)return t;r<0&&(r=0),e>this.length&&(e=this.length);for(var n=this.length,s=this.tail;s!==null&&n>e;n--)s=s.prev;for(;s!==null&&n>r;n--,s=s.prev)t.push(s.value);return t};S.prototype.splice=function(r,e,...t){r>this.length&&(r=this.length-1),r<0&&(r=this.length+r);for(var n=0,s=this.head;s!==null&&n<r;n++)s=s.next;for(var a=[],n=0;s&&n<e;n++)a.push(s.value),s=this.removeNode(s);s===null&&(s=this.tail),s!==this.head&&s!==this.tail&&(s=s.prev);for(var n=0;n<t.length;n++)s=Qr(this,s,t[n]);return a};S.prototype.reverse=function(){for(var r=this.head,e=this.tail,t=r;t!==null;t=t.prev){var n=t.prev;t.prev=t.next,t.next=n}return this.head=e,this.tail=r,this};function Qr(r,e,t){var n=e===r.head?new K(t,null,e,r):new K(t,e,e.next,r);return n.next===null&&(r.tail=n),n.prev===null&&(r.head=n),r.length++,n}function en(r,e){r.tail=new K(e,r.tail,null,r),r.head||(r.head=r.tail),r.length++}function tn(r,e){r.head=new K(e,null,r.head,r),r.tail||(r.tail=r.head),r.length++}function K(r,e,t,n){if(!(this instanceof K))return new K(r,e,t,n);this.list=n,this.value=r,e?(e.next=this,this.prev=e):this.prev=null,t?(t.prev=this,this.next=t):this.next=null}try{Zr()(S)}catch{}const rn=Kr,J=Symbol("max"),q=Symbol("length"),ee=Symbol("lengthCalculator"),oe=Symbol("allowStale"),Z=Symbol("maxAge"),W=Symbol("dispose"),Ke=Symbol("noDisposeOnSet"),L=Symbol("lruList"),V=Symbol("cache"),ft=Symbol("updateAgeOnGet"),Se=()=>1;class nn{constructor(e){if(typeof e=="number"&&(e={max:e}),e||(e={}),e.max&&(typeof e.max!="number"||e.max<0))throw new TypeError("max must be a non-negative number");this[J]=e.max||1/0;const t=e.length||Se;if(this[ee]=typeof t!="function"?Se:t,this[oe]=e.stale||!1,e.maxAge&&typeof e.maxAge!="number")throw new TypeError("maxAge must be a number");this[Z]=e.maxAge||0,this[W]=e.dispose,this[Ke]=e.noDisposeOnSet||!1,this[ft]=e.updateAgeOnGet||!1,this.reset()}set max(e){if(typeof e!="number"||e<0)throw new TypeError("max must be a non-negative number");this[J]=e||1/0,se(this)}get max(){return this[J]}set allowStale(e){this[oe]=!!e}get allowStale(){return this[oe]}set maxAge(e){if(typeof e!="number")throw new TypeError("maxAge must be a non-negative number");this[Z]=e,se(this)}get maxAge(){return this[Z]}set lengthCalculator(e){typeof e!="function"&&(e=Se),e!==this[ee]&&(this[ee]=e,this[q]=0,this[L].forEach(t=>{t.length=this[ee](t.value,t.key),this[q]+=t.length})),se(this)}get lengthCalculator(){return this[ee]}get length(){return this[q]}get itemCount(){return this[L].length}rforEach(e,t){t=t||this;for(let n=this[L].tail;n!==null;){const s=n.prev;Qe(this,e,n,t),n=s}}forEach(e,t){t=t||this;for(let n=this[L].head;n!==null;){const s=n.next;Qe(this,e,n,t),n=s}}keys(){return this[L].toArray().map(e=>e.key)}values(){return this[L].toArray().map(e=>e.value)}reset(){this[W]&&this[L]&&this[L].length&&this[L].forEach(e=>this[W](e.key,e.value)),this[V]=new Map,this[L]=new rn,this[q]=0}dump(){return this[L].map(e=>pe(this,e)?!1:{k:e.key,v:e.value,e:e.now+(e.maxAge||0)}).toArray().filter(e=>e)}dumpLru(){return this[L]}set(e,t,n){if(n=n||this[Z],n&&typeof n!="number")throw new TypeError("maxAge must be a number");const s=n?Date.now():0,a=this[ee](t,e);if(this[V].has(e)){if(a>this[J])return te(this,this[V].get(e)),!1;const o=this[V].get(e).value;return this[W]&&(this[Ke]||this[W](e,o.value)),o.now=s,o.maxAge=n,o.value=t,this[q]+=a-o.length,o.length=a,this.get(e),se(this),!0}const i=new an(e,t,a,s,n);return i.length>this[J]?(this[W]&&this[W](e,t),!1):(this[q]+=i.length,this[L].unshift(i),this[V].set(e,this[L].head),se(this),!0)}has(e){if(!this[V].has(e))return!1;const t=this[V].get(e).value;return!pe(this,t)}get(e){return ke(this,e,!0)}peek(e){return ke(this,e,!1)}pop(){const e=this[L].tail;return e?(te(this,e),e.value):null}del(e){te(this,this[V].get(e))}load(e){this.reset();const t=Date.now();for(let n=e.length-1;n>=0;n--){const s=e[n],a=s.e||0;if(a===0)this.set(s.k,s.v);else{const i=a-t;i>0&&this.set(s.k,s.v,i)}}}prune(){this[V].forEach((e,t)=>ke(this,t,!1))}}const ke=(r,e,t)=>{const n=r[V].get(e);if(n){const s=n.value;if(pe(r,s)){if(te(r,n),!r[oe])return}else t&&(r[ft]&&(n.value.now=Date.now()),r[L].unshiftNode(n));return s.value}},pe=(r,e)=>{if(!e||!e.maxAge&&!r[Z])return!1;const t=Date.now()-e.now;return e.maxAge?t>e.maxAge:r[Z]&&t>r[Z]},se=r=>{if(r[q]>r[J])for(let e=r[L].tail;r[q]>r[J]&&e!==null;){const t=e.prev;te(r,e),e=t}},te=(r,e)=>{if(e){const t=e.value;r[W]&&r[W](t.key,t.value),r[q]-=t.length,r[V].delete(t.key),r[L].removeNode(e)}};class an{constructor(e,t,n,s,a){this.key=e,this.value=t,this.length=n,this.now=s,this.maxAge=a||0}}const Qe=(r,e,t,n)=>{let s=t.value;pe(r,s)&&(te(r,t),r[oe]||(s=void 0)),s&&e.call(n,s.value,s.key,r)};var sn=nn,Re,et;function M(){if(et)return Re;et=1;class r{constructor(h,g){if(g=n(g),h instanceof r)return h.loose===!!g.loose&&h.includePrerelease===!!g.includePrerelease?h:new r(h.raw,g);if(h instanceof s)return this.raw=h.value,this.set=[[h]],this.format(),this;if(this.options=g,this.loose=!!g.loose,this.includePrerelease=!!g.includePrerelease,this.raw=h,this.set=h.split("||").map(m=>this.parseRange(m.trim())).filter(m=>m.length),!this.set.length)throw new TypeError(`Invalid SemVer Range: ${h}`);if(this.set.length>1){const m=this.set[0];if(this.set=this.set.filter(p=>!v(p[0])),this.set.length===0)this.set=[m];else if(this.set.length>1){for(const p of this.set)if(p.length===1&&b(p[0])){this.set=[p];break}}}this.format()}format(){return this.range=this.set.map(h=>h.join(" ").trim()).join("||").trim(),this.range}toString(){return this.range}parseRange(h){h=h.trim();const m=`parseRange:${Object.keys(this.options).join(",")}:${h}`,p=t.get(m);if(p)return p;const f=this.options.loose,A=f?c[o.HYPHENRANGELOOSE]:c[o.HYPHENRANGE];h=h.replace(A,At(this.options.includePrerelease)),a("hyphen replace",h),h=h.replace(c[o.COMPARATORTRIM],w),a("comparator trim",h),h=h.replace(c[o.TILDETRIM],l),h=h.replace(c[o.CARETTRIM],d),h=h.split(/\s+/).join(" ");let k=h.split(" ").map(N=>y(N,this.options)).join(" ").split(/\s+/).map(N=>vt(N,this.options));f&&(k=k.filter(N=>(a("loose invalid filter",N,this.options),!!N.match(c[o.COMPARATORLOOSE])))),a("range list",k);const E=new Map,$=k.map(N=>new s(N,this.options));for(const N of $){if(v(N))return[N];E.set(N.value,N)}E.size>1&&E.has("")&&E.delete("");const F=[...E.values()];return t.set(m,F),F}intersects(h,g){if(!(h instanceof r))throw new TypeError("a Range is required");return this.set.some(m=>C(m,g)&&h.set.some(p=>C(p,g)&&m.every(f=>p.every(A=>f.intersects(A,g)))))}test(h){if(!h)return!1;if(typeof h=="string")try{h=new i(h,this.options)}catch{return!1}for(let g=0;g<this.set.length;g++)if(yt(this.set[g],h,this.options))return!0;return!1}}Re=r;const e=sn,t=new e({max:1e3}),n=ve,s=ye(),a=we,i=B,{re:c,t:o,comparatorTrimReplace:w,tildeTrimReplace:l,caretTrimReplace:d}=z.exports,v=u=>u.value==="<0.0.0-0",b=u=>u.value==="",C=(u,h)=>{let g=!0;const m=u.slice();let p=m.pop();for(;g&&m.length;)g=m.every(f=>p.intersects(f,h)),p=m.pop();return g},y=(u,h)=>(a("comp",u,h),u=le(u,h),a("caret",u),u=I(u,h),a("tildes",u),u=pt(u,h),a("xrange",u),u=wt(u,h),a("stars",u),u),T=u=>!u||u.toLowerCase()==="x"||u==="*",I=(u,h)=>u.trim().split(/\s+/).map(g=>Y(g,h)).join(" "),Y=(u,h)=>{const g=h.loose?c[o.TILDELOOSE]:c[o.TILDE];return u.replace(g,(m,p,f,A,k)=>{a("tilde",u,m,p,f,A,k);let E;return T(p)?E="":T(f)?E=`>=${p}.0.0 <${+p+1}.0.0-0`:T(A)?E=`>=${p}.${f}.0 <${p}.${+f+1}.0-0`:k?(a("replaceTilde pr",k),E=`>=${p}.${f}.${A}-${k} <${p}.${+f+1}.0-0`):E=`>=${p}.${f}.${A} <${p}.${+f+1}.0-0`,a("tilde return",E),E})},le=(u,h)=>u.trim().split(/\s+/).map(g=>ne(g,h)).join(" "),ne=(u,h)=>{a("caret",u,h);const g=h.loose?c[o.CARETLOOSE]:c[o.CARET],m=h.includePrerelease?"-0":"";return u.replace(g,(p,f,A,k,E)=>{a("caret",u,p,f,A,k,E);let $;return T(f)?$="":T(A)?$=`>=${f}.0.0${m} <${+f+1}.0.0-0`:T(k)?f==="0"?$=`>=${f}.${A}.0${m} <${f}.${+A+1}.0-0`:$=`>=${f}.${A}.0${m} <${+f+1}.0.0-0`:E?(a("replaceCaret pr",E),f==="0"?A==="0"?$=`>=${f}.${A}.${k}-${E} <${f}.${A}.${+k+1}-0`:$=`>=${f}.${A}.${k}-${E} <${f}.${+A+1}.0-0`:$=`>=${f}.${A}.${k}-${E} <${+f+1}.0.0-0`):(a("no pr"),f==="0"?A==="0"?$=`>=${f}.${A}.${k}${m} <${f}.${A}.${+k+1}-0`:$=`>=${f}.${A}.${k}${m} <${f}.${+A+1}.0-0`:$=`>=${f}.${A}.${k} <${+f+1}.0.0-0`),a("caret return",$),$})},pt=(u,h)=>(a("replaceXRanges",u,h),u.split(/\s+/).map(g=>gt(g,h)).join(" ")),gt=(u,h)=>{u=u.trim();const g=h.loose?c[o.XRANGELOOSE]:c[o.XRANGE];return u.replace(g,(m,p,f,A,k,E)=>{a("xRange",u,m,p,f,A,k,E);const $=T(f),F=$||T(A),N=F||T(k),ae=N;return p==="="&&ae&&(p=""),E=h.includePrerelease?"-0":"",$?p===">"||p==="<"?m="<0.0.0-0":m="*":p&&ae?(F&&(A=0),k=0,p===">"?(p=">=",F?(f=+f+1,A=0,k=0):(A=+A+1,k=0)):p==="<="&&(p="<",F?f=+f+1:A=+A+1),p==="<"&&(E="-0"),m=`${p+f}.${A}.${k}${E}`):F?m=`>=${f}.0.0${E} <${+f+1}.0.0-0`:N&&(m=`>=${f}.${A}.0${E} <${f}.${+A+1}.0-0`),a("xRange return",m),m})},wt=(u,h)=>(a("replaceStars",u,h),u.trim().replace(c[o.STAR],"")),vt=(u,h)=>(a("replaceGTE0",u,h),u.trim().replace(c[h.includePrerelease?o.GTE0PRE:o.GTE0],"")),At=u=>(h,g,m,p,f,A,k,E,$,F,N,ae,Qn)=>(T(m)?g="":T(p)?g=`>=${m}.0.0${u?"-0":""}`:T(f)?g=`>=${m}.${p}.0${u?"-0":""}`:A?g=`>=${g}`:g=`>=${g}${u?"-0":""}`,T($)?E="":T(F)?E=`<${+$+1}.0.0-0`:T(N)?E=`<${$}.${+F+1}.0-0`:ae?E=`<=${$}.${F}.${N}-${ae}`:u?E=`<${$}.${F}.${+N+1}-0`:E=`<=${E}`,`${g} ${E}`.trim()),yt=(u,h,g)=>{for(let m=0;m<u.length;m++)if(!u[m].test(h))return!1;if(h.prerelease.length&&!g.includePrerelease){for(let m=0;m<u.length;m++)if(a(u[m].semver),u[m].semver!==s.ANY&&u[m].semver.prerelease.length>0){const p=u[m].semver;if(p.major===h.major&&p.minor===h.minor&&p.patch===h.patch)return!0}return!1}return!0};return Re}var Ce,tt;function ye(){if(tt)return Ce;tt=1;const r=Symbol("SemVer ANY");class e{static get ANY(){return r}constructor(l,d){if(d=t(d),l instanceof e){if(l.loose===!!d.loose)return l;l=l.value}i("comparator",l,d),this.options=d,this.loose=!!d.loose,this.parse(l),this.semver===r?this.value="":this.value=this.operator+this.semver.version,i("comp",this)}parse(l){const d=this.options.loose?n[s.COMPARATORLOOSE]:n[s.COMPARATOR],v=l.match(d);if(!v)throw new TypeError(`Invalid comparator: ${l}`);this.operator=v[1]!==void 0?v[1]:"",this.operator==="="&&(this.operator=""),v[2]?this.semver=new c(v[2],this.options.loose):this.semver=r}toString(){return this.value}test(l){if(i("Comparator.test",l,this.options.loose),this.semver===r||l===r)return!0;if(typeof l=="string")try{l=new c(l,this.options)}catch{return!1}return a(l,this.operator,this.semver,this.options)}intersects(l,d){if(!(l instanceof e))throw new TypeError("a Comparator is required");if((!d||typeof d!="object")&&(d={loose:!!d,includePrerelease:!1}),this.operator==="")return this.value===""?!0:new o(l.value,d).test(this.value);if(l.operator==="")return l.value===""?!0:new o(this.value,d).test(l.semver);const v=(this.operator===">="||this.operator===">")&&(l.operator===">="||l.operator===">"),b=(this.operator==="<="||this.operator==="<")&&(l.operator==="<="||l.operator==="<"),C=this.semver.version===l.semver.version,y=(this.operator===">="||this.operator==="<=")&&(l.operator===">="||l.operator==="<="),T=a(this.semver,"<",l.semver,d)&&(this.operator===">="||this.operator===">")&&(l.operator==="<="||l.operator==="<"),I=a(this.semver,">",l.semver,d)&&(this.operator==="<="||this.operator==="<")&&(l.operator===">="||l.operator===">");return v||b||C&&y||T||I}}Ce=e;const t=ve,{re:n,t:s}=z.exports,a=bt,i=we,c=B,o=M();return Ce}const on=M(),ln=(r,e,t)=>{try{e=new on(e,t)}catch{return!1}return e.test(r)};var Ee=ln;const dn=M(),hn=(r,e)=>new dn(r,e).set.map(t=>t.map(n=>n.value).join(" ").trim().split(" "));var cn=hn;const un=B,bn=M(),fn=(r,e,t)=>{let n=null,s=null,a=null;try{a=new bn(e,t)}catch{return null}return r.forEach(i=>{a.test(i)&&(!n||s.compare(i)===-1)&&(n=i,s=new un(n,t))}),n};var mn=fn;const pn=B,gn=M(),wn=(r,e,t)=>{let n=null,s=null,a=null;try{a=new gn(e,t)}catch{return null}return r.forEach(i=>{a.test(i)&&(!n||s.compare(i)===1)&&(n=i,s=new pn(n,t))}),n};var vn=wn;const Ie=B,An=M(),rt=Ae,yn=(r,e)=>{r=new An(r,e);let t=new Ie("0.0.0");if(r.test(t)||(t=new Ie("0.0.0-0"),r.test(t)))return t;t=null;for(let n=0;n<r.set.length;++n){const s=r.set[n];let a=null;s.forEach(i=>{const c=new Ie(i.semver.version);switch(i.operator){case">":c.prerelease.length===0?c.patch++:c.prerelease.push(0),c.raw=c.format();case"":case">=":(!a||rt(c,a))&&(a=c);break;case"<":case"<=":break;default:throw new Error(`Unexpected operation: ${i.operator}`)}}),a&&(!t||rt(t,a))&&(t=a)}return t&&r.test(t)?t:null};var En=yn;const Tn=M(),Sn=(r,e)=>{try{return new Tn(r,e).range||"*"}catch{return null}};var kn=Sn;const Rn=B,mt=ye(),{ANY:Cn}=mt,In=M(),$n=Ee,nt=Ae,at=Be,xn=Ge,Nn=Fe,Ln=(r,e,t,n)=>{r=new Rn(r,n),e=new In(e,n);let s,a,i,c,o;switch(t){case">":s=nt,a=xn,i=at,c=">",o=">=";break;case"<":s=at,a=Nn,i=nt,c="<",o="<=";break;default:throw new TypeError('Must provide a hilo val of "<" or ">"')}if($n(r,e,n))return!1;for(let w=0;w<e.set.length;++w){const l=e.set[w];let d=null,v=null;if(l.forEach(b=>{b.semver===Cn&&(b=new mt(">=0.0.0")),d=d||b,v=v||b,s(b.semver,d.semver,n)?d=b:i(b.semver,v.semver,n)&&(v=b)}),d.operator===c||d.operator===o||(!v.operator||v.operator===c)&&a(r,v.semver))return!1;if(v.operator===o&&i(r,v.semver))return!1}return!0};var De=Ln;const On=De,Pn=(r,e,t)=>On(r,e,">",t);var Bn=Pn;const Fn=De,Gn=(r,e,t)=>Fn(r,e,"<",t);var Dn=Gn;const st=M(),Un=(r,e,t)=>(r=new st(r,t),e=new st(e,t),r.intersects(e));var _n=Un;const Hn=Ee,Vn=j;var jn=(r,e,t)=>{const n=[];let s=null,a=null;const i=r.sort((l,d)=>Vn(l,d,t));for(const l of i)Hn(l,e,t)?(a=l,s||(s=l)):(a&&n.push([s,a]),a=null,s=null);s&&n.push([s,null]);const c=[];for(const[l,d]of n)l===d?c.push(l):!d&&l===i[0]?c.push("*"):d?l===i[0]?c.push(`<=${d}`):c.push(`${l} - ${d}`):c.push(`>=${l}`);const o=c.join(" || "),w=typeof e.raw=="string"?e.raw:String(e);return o.length<w.length?o:e};const it=M(),be=ye(),{ANY:$e}=be,ie=Ee,Ue=j,Mn=(r,e,t={})=>{if(r===e)return!0;r=new it(r,t),e=new it(e,t);let n=!1;e:for(const s of r.set){for(const a of e.set){const i=Wn(s,a,t);if(n=n||i!==null,i)continue e}if(n)return!1}return!0},Wn=(r,e,t)=>{if(r===e)return!0;if(r.length===1&&r[0].semver===$e){if(e.length===1&&e[0].semver===$e)return!0;t.includePrerelease?r=[new be(">=0.0.0-0")]:r=[new be(">=0.0.0")]}if(e.length===1&&e[0].semver===$e){if(t.includePrerelease)return!0;e=[new be(">=0.0.0")]}const n=new Set;let s,a;for(const b of r)b.operator===">"||b.operator===">="?s=ot(s,b,t):b.operator==="<"||b.operator==="<="?a=lt(a,b,t):n.add(b.semver);if(n.size>1)return null;let i;if(s&&a){if(i=Ue(s.semver,a.semver,t),i>0)return null;if(i===0&&(s.operator!==">="||a.operator!=="<="))return null}for(const b of n){if(s&&!ie(b,String(s),t)||a&&!ie(b,String(a),t))return null;for(const C of e)if(!ie(b,String(C),t))return!1;return!0}let c,o,w,l,d=a&&!t.includePrerelease&&a.semver.prerelease.length?a.semver:!1,v=s&&!t.includePrerelease&&s.semver.prerelease.length?s.semver:!1;d&&d.prerelease.length===1&&a.operator==="<"&&d.prerelease[0]===0&&(d=!1);for(const b of e){if(l=l||b.operator===">"||b.operator===">=",w=w||b.operator==="<"||b.operator==="<=",s){if(v&&b.semver.prerelease&&b.semver.prerelease.length&&b.semver.major===v.major&&b.semver.minor===v.minor&&b.semver.patch===v.patch&&(v=!1),b.operator===">"||b.operator===">="){if(c=ot(s,b,t),c===b&&c!==s)return!1}else if(s.operator===">="&&!ie(s.semver,String(b),t))return!1}if(a){if(d&&b.semver.prerelease&&b.semver.prerelease.length&&b.semver.major===d.major&&b.semver.minor===d.minor&&b.semver.patch===d.patch&&(d=!1),b.operator==="<"||b.operator==="<="){if(o=lt(a,b,t),o===b&&o!==a)return!1}else if(a.operator==="<="&&!ie(a.semver,String(b),t))return!1}if(!b.operator&&(a||s)&&i!==0)return!1}return!(s&&w&&!a&&i!==0||a&&l&&!s&&i!==0||v||d)},ot=(r,e,t)=>{if(!r)return e;const n=Ue(r.semver,e.semver,t);return n>0?r:n<0||e.operator===">"&&r.operator===">="?e:r},lt=(r,e,t)=>{if(!r)return e;const n=Ue(r.semver,e.semver,t);return n<0?r:n>0||e.operator==="<"&&r.operator==="<="?e:r};var qn=Mn;const xe=z.exports;xe.re,xe.src,xe.t,ge.SEMVER_SPEC_VERSION,Ne.compareIdentifiers,Ne.rcompareIdentifiers,ye(),M();function dt(r,e,t){const n=r.slice();return n[1]=e[t],n}function Xn(r){let e,t,n,s=r[1].mcVersion+"",a,i,c=r[1].version+"",o;return{c(){e=G("a"),t=G("h3"),n=O("ChaosAwakens Beta - "),a=O(s),i=O(" - "),o=O(c),this.h()},l(w){e=D(w,"A",{href:!0});var l=U(e);t=D(l,"H3",{class:!0});var d=U(t);n=P(d,"ChaosAwakens Beta - "),a=P(d,s),i=P(d," - "),o=P(d,c),d.forEach(x),l.forEach(x),this.h()},h(){_(t,"class","svelte-1rm1xus"),_(e,"href","downloads/ChaosAwakensBeta"+r[1].mcVersion+"v"+r[1].version+".jar")},m(w,l){X(w,e,l),R(e,t),R(t,n),R(t,a),R(t,i),R(t,o)},p:Le,d(w){w&&x(e)}}}function zn(r){let e,t,n,s=r[1].mcVersion+"",a,i,c=r[1].version+"",o;return{c(){e=G("a"),t=G("h3"),n=O("ChaosAwakens Alpha - "),a=O(s),i=O(" - "),o=O(c),this.h()},l(w){e=D(w,"A",{href:!0});var l=U(e);t=D(l,"H3",{class:!0});var d=U(t);n=P(d,"ChaosAwakens Alpha - "),a=P(d,s),i=P(d," - "),o=P(d,c),d.forEach(x),l.forEach(x),this.h()},h(){_(t,"class","svelte-1rm1xus"),_(e,"href","downloads/ChaosAwakensAlpha"+r[1].mcVersion+"v"+r[1].version+".jar")},m(w,l){X(w,e,l),R(e,t),R(t,n),R(t,a),R(t,i),R(t,o)},p:Le,d(w){w&&x(e)}}}function Yn(r){let e,t,n,s=r[1].mcVersion+"",a,i,c=r[1].version+"",o;return{c(){e=G("a"),t=G("h3"),n=O("ChaosAwakens - "),a=O(s),i=O(" - "),o=O(c),this.h()},l(w){e=D(w,"A",{href:!0});var l=U(e);t=D(l,"H3",{class:!0});var d=U(t);n=P(d,"ChaosAwakens - "),a=P(d,s),i=P(d," - "),o=P(d,c),d.forEach(x),l.forEach(x),this.h()},h(){_(t,"class","svelte-1rm1xus"),_(e,"href","downloads/chaosawakens-"+r[1].mcVersion+"-"+r[1].version+".jar")},m(w,l){X(w,e,l),R(e,t),R(t,n),R(t,a),R(t,i),R(t,o)},p:Le,d(w){w&&x(e)}}}function ht(r){let e,t,n,s,a=r[1].changelog+"",i;function c(l,d){return l[1].branch=="stable"?Yn:l[1].branch=="alpha"?zn:Xn}let w=c(r)(r);return{c(){e=G("details"),t=G("summary"),w.c(),n=fe(),s=G("p"),i=fe(),this.h()},l(l){e=D(l,"DETAILS",{class:!0});var d=U(e);t=D(d,"SUMMARY",{class:!0});var v=U(t);w.l(v),v.forEach(x),n=me(d),s=D(d,"P",{class:!0});var b=U(s);b.forEach(x),i=me(d),d.forEach(x),this.h()},h(){_(t,"class","svelte-1rm1xus"),_(s,"class","svelte-1rm1xus"),_(e,"class","svelte-1rm1xus")},m(l,d){X(l,e,d),R(e,t),w.m(t,null),R(e,n),R(e,s),s.innerHTML=a,R(e,i)},p(l,d){w.p(l,d)},d(l){l&&x(e),w.d()}}}function Jn(r){let e,t,n,s,a,i,c,o,w,l,d,v;e=new Lt({props:{title:"Downloads"}});let b=r[0],C=[];for(let y=0;y<b.length;y+=1)C[y]=ht(dt(r,b,y));return{c(){kt(e.$$.fragment),t=fe(),n=G("h3"),s=G("a"),a=O("GeckoLib"),i=O(" and "),c=G("a"),o=O("AttributeFix"),w=O(" are required for the mod to function!"),l=fe(),d=G("div");for(let y=0;y<C.length;y+=1)C[y].c();this.h()},l(y){Rt(e.$$.fragment,y),t=me(y),n=D(y,"H3",{class:!0});var T=U(n);s=D(T,"A",{href:!0});var I=U(s);a=P(I,"GeckoLib"),I.forEach(x),i=P(T," and "),c=D(T,"A",{href:!0});var Y=U(c);o=P(Y,"AttributeFix"),Y.forEach(x),w=P(T," are required for the mod to function!"),T.forEach(x),l=me(y),d=D(y,"DIV",{class:!0});var le=U(d);for(let ne=0;ne<C.length;ne+=1)C[ne].l(le);le.forEach(x),this.h()},h(){_(s,"href","https://www.curseforge.com/minecraft/mc-mods/geckolib/"),_(c,"href","https://www.curseforge.com/minecraft/mc-mods/attributefix"),_(n,"class","svelte-1rm1xus"),_(d,"class","versions")},m(y,T){Ct(e,y,T),X(y,t,T),X(y,n,T),R(n,s),R(s,a),R(n,i),R(n,c),R(c,o),R(n,w),X(y,l,T),X(y,d,T);for(let I=0;I<C.length;I+=1)C[I].m(d,null);v=!0},p(y,[T]){if(T&1){b=y[0];let I;for(I=0;I<b.length;I+=1){const Y=dt(y,b,I);C[I]?C[I].p(Y,T):(C[I]=ht(Y),C[I].c(),C[I].m(d,null))}for(;I<C.length;I+=1)C[I].d(1);C.length=b.length}},i(y){v||(It(e.$$.fragment,y),v=!0)},o(y){$t(e.$$.fragment,y),v=!1},d(y){xt(e,y),y&&x(t),y&&x(n),y&&x(l),y&&x(d),Nt(C,y)}}}function Zn(r,e){var t,n,s;for(r=(r.version+"").split("."),e=(e.version+"").split("."),s=Math.max(r.length,e.length),t=0;t<s;t++)if(r[t]===void 0&&(r[t]="0"),e[t]===void 0&&(e[t]="0"),n=parseInt(r[t],10)-parseInt(e[t],10),n!==0)return n<0?-1:1;return 0}function Kn(r){let e=[{version:"0.9.0.0",mcVersion:"1.16.5",branch:"stable",changelog:`
...
<br>
				...
				- Tweaked some ore spawning rates.`},{version:"0.1",mcVersion:"1.16.5",branch:"alpha",changelog:`
